...
export interface components {
  schemas: {
    ...
    ContentBodyConversionInput: {
      ...
      to: string;
      /**
       * @description Controls whether conversion results are cached and reused for identical requests.
       *
    ...
    Group: {
      ...
      id: string;
      /**
       * @description This property represents how this collection of users is used:
       ...
       * @default USERBASE_GROUP
       * @enum {string}
       */
      usageType: "USERBASE_GROUP" | "TEAM_COLLABORATION";
      /**
       * @description This property represents how this collection of users is managed:
...
export interface operations {
  ...
  getAndAsyncConvertMacroBodyByMacroId: {
    parameters: {
      query?: {
         ...
         *       - Returns the same task ID for identical requests, allowing you to retrieve the cached result
         *
         *     For large macros that are slow to convert and for which it is acceptable to show cached data, set this field to `true`.
         */
        allowCache?: boolean;
        /**
         * @description The space key used for resolving embedded content (page includes,
  ...
  addLabelsToContent: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["LabelCreateArray"]
          | components["schemas"]["LabelCreate"];
      };
    };
    responses: {
